...
public class CityOneDenver extends AppCompatActivity {
   ...
   adView = findViewById(R.id.adView);
        ...
        if (isNetworkConnected()) {
            showProgressDialog();
            FirebaseDatabase.getInstance().getReference("JobConnectOne/CityOneDenver").orderByValue().addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (fanList.size() > 0) {
                        adapter = new JobConnectAdapter(CityOneDenver.this, fanList);
                ...
                public void onCancelled(DatabaseError databaseError) {
                    ...
                    Toast.makeText(CityOneDenver.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
        }else {
            Toast.makeText(CityOneDenver.this, R.string.check_the_network, Toast.LENGTH_LONG).show();
            hideProgressDialog();
        }
