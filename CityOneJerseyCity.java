...
public class CityOneJerseyCity extends AppCompatActivity {
   ...
   adView = findViewById(R.id.adView);
        ...
        if (isNetworkConnected()) {
            showProgressDialog();
            FirebaseDatabase.getInstance().getReference("JobConnectOne/CityOneJerseyCity").orderByValue().addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (fanList.size() > 0) {
                        adapter = new JobConnectAdapter(CityOneJerseyCity.this, fanList);
                ...
                public void onCancelled(DatabaseError databaseError) {
                    ...
                    Toast.makeText(CityOneJerseyCity.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
        }else {
            Toast.makeText(CityOneJerseyCity.this, R.string.check_the_network, Toast.LENGTH_LONG).show();
            hideProgressDialog();
        }
