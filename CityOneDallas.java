...
public class CityOneDallas extends AppCompatActivity {
   ...
   adView = findViewById(R.id.adView);
        ...
        if (isNetworkConnected()) {
            showProgressDialog();
            FirebaseDatabase.getInstance().getReference("JobConnectOne/CityOneDallas").orderByValue().addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (fanList.size() > 0) {
                        adapter = new JobConnectAdapter(CityOneDallas.this, fanList);
                ...
                public void onCancelled(DatabaseError databaseError) {
                    ...
                    Toast.makeText(CityOneDallas.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
        }else {
            Toast.makeText(CityOneDallas.this, R.string.check_the_network, Toast.LENGTH_LONG).show();
            hideProgressDialog();
        }
