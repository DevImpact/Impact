...
public class CityOneLouisville extends AppCompatActivity {
   ...
   adView = findViewById(R.id.adView);
        ...
        if (isNetworkConnected()) {
            showProgressDialog();
            FirebaseDatabase.getInstance().getReference("JobConnectOne/CityOneLouisville").orderByValue().addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (fanList.size() > 0) {
                        adapter = new JobConnectAdapter(CityOneLouisville.this, fanList);
                ...
                public void onCancelled(DatabaseError databaseError) {
                    ...
                    Toast.makeText(CityOneLouisville.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
        }else {
            Toast.makeText(CityOneLouisville.this, R.string.check_the_network, Toast.LENGTH_LONG).show();
            hideProgressDialog();
        }
