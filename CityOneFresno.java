...
public class CityOneFresno extends AppCompatActivity {
   ...
   adView = findViewById(R.id.adView);
        ...
        if (isNetworkConnected()) {
            showProgressDialog();
            FirebaseDatabase.getInstance().getReference("JobConnectOne/CityOneFresno").orderByValue().addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (fanList.size() > 0) {
                        adapter = new JobConnectAdapter(CityOneFresno.this, fanList);
                ...
                public void onCancelled(DatabaseError databaseError) {
                    ...
                    Toast.makeText(CityOneFresno.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
        }else {
            Toast.makeText(CityOneFresno.this, R.string.check_the_network, Toast.LENGTH_LONG).show();
            hideProgressDialog();
        }
